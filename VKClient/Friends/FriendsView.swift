...
class FriendsView: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var friendsData: [userVK] = [
        ...
        (userVK(name: "Kuroneko", sername: "- sama", avatar: UIImage(named: "kuroneko0")!, photo: [UIImage(named: "kuroneko1")!, UIImage(named: "kuroneko2")!, UIImage(named: "kuroneko3")!], gender: .female , idGroup: 1, city: "Gunsmoke")),
