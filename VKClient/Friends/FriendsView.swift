...
class FriendsView: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var friendsData: [userVK] = [(userVK(name: "Vash", sername: "the Stampede", avatar: UIImage(named: "trigunicon")!, photo: [UIImage(named: "trigunimage")!, UIImage(named: "vash1")!, UIImage(named: "vash2")!, UIImage(named: "vash3")!, UIImage(named: "vash4.jpg")!, UIImage(named: "vash5.jpg")!], gender: .male, idGroup: 1, city: "Gunsmoke")),
                                 ...
                                 (userVK(name: "Nicholas D.", sername: "Wolfwood", avatar: UIImage(named: "wolfwoodavatar")!, photo: [UIImage(named: "wolfwood2")!, UIImage(named: "wolfwood3")!], gender: .male , idGroup: 1, city: "Evergreen")),
                                 ...
                                 (userVK(name: "Meryl", sername: "Stryfe", avatar: UIImage(named: "merylavatar")!, photo: [UIImage(named: "meryl1")!, UIImage(named: "meryl2")!, UIImage(named: "meryl3")!], gender: .female , idGroup: 1, city: "Gunsmoke")),
                                 (userVK(name: "Milly", sername: "Thompson", avatar: UIImage(named: "millyavatar")!, photo: [UIImage(named: "milly1")!, UIImage(named: "milly2")!, UIImage(named: "milly3")!], gender: .female , idGroup: 1, city: "Gunsmoke")),
                                 (userVK(name: "Kuroneko", sername: "-sama", avatar: UIImage(named: "kuronekoavatar")!, photo: [UIImage(named: "kuroneko1")!, UIImage(named: "kuroneko2")!, UIImage(named: "kuroneko3")!], gender: .female , idGroup: 1, city: "Gunsmoke")),
